...
sodium=st.sidebar.number_input("sodium(mEq/L,Nrom:135-145,model range:0-200)")
...
alt=st.sidebar.number_input("alt(IU/L,Norm:7-56,model range:10-400)")
temperature=st.sidebar.number_input("temperature(°C,Norm:36.5-37.5,model range:35-50)")
platelet_count=st.sidebar.number_input("platelet count(K/μL,Norm:150-450,model range:0-500)")
